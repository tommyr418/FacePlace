...
Profile.create(user_id: user1.id, category: "familyAndRelationships",
...
Friend.destroy_all
Friend.create(friender_id: user1.id, friendee_id: f1.id)
Friend.create(friender_id: user1.id, friendee_id: f2.id)
Friend.create(friender_id: f3.id, friendee_id: user1.id)
Friend.create(friender_id: user1.id, friendee_id: f4.id)
Friend.create(friender_id: f5.id, friendee_id: user1.id)
Friend.create(friender_id: f6.id, friendee_id: user1.id)
Friend.create(friender_id: user1.id, friendee_id: f7.id)

User.all.each do |person|
  next if user1.id == person.id
  2.times do
